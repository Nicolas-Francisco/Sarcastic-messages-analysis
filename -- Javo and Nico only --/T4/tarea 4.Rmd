...
**Respuesta:** Calculemos primero las medidas de interés de ambas reglas:
Teniendo que
...
Donde $N$ es la cantidad de transacciones (el tamaño del dataset), podemos calcular estas medidas para ambas reglas.

La primera medida que calcularemos será el support, el cuál por la razón de los datos del dataset, naturalmente serán iguales:
...
Por otro lado, podemos calcular la confianza de ambas reglas.
